	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				...
				token: entity.NewToken("eyJhbGciOiJSUzUxMiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIzNjRiOGIwZC00ZDg1LTRiMjMtOWQ3Ny0wNTRmMDY5MGU0OTgiLCJhdWQiOlsiYWNjZXNzIl0sImV4cCI6MTc0NzY1MjQzOCwibmJmIjoxNjYxMjUyNDM4LCJpYXQiOjE2NjEyNTI0MzgsImp0aSI6ImViY2M0MDUwLTU3YzMtNGVlMy1hNjMzLWY1NzgyOTc0MjRjYSJ9.N2amwawNdnpgVNcZq4LOwtcDK88USnilTPeH79Dvv10oHU2QW4hC4t68n7LcbPRWyX-ZwvhcpWAq3xaTkGNP0vmvuPGUJrPcwbxmqSdXLrrg7U-xH2tyXtdSZeZwtYgSp3D9haQXTm74S2fqNDvhhSx28Pp_3uSsXMYzxS4R2mo"),
			},
		...
		},
		{
			...
			args: args{
				in0:   context.Background(),
				token: entity.NewToken("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdWQiOiJhY2Nlc3MiLCJqdGkiOiJwMzE3OWQwZC0zM2VkLTQ0ZjYtOGEyMS05MzExZGExMWU3OWYiLCJzdWIiOiJjYzRhMzU1YS05NDdmLTRmYTQtYWY0Ny00ZmZmMWVhZTA2YTEifQ.6-U_fSeDCLfXtYlJ6aivTw-4O3-EuVVw2KYWNNay5zU"),
			},
			want: "",
			wantErr: &errs.Error{
				Code:    16,
...
func TestAuthRepository_Validate(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			args: args{
				token: entity.NewToken("eyJhbGciOiJSUzUxMiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIzNjRiOGIwZC00ZDg1LTRiMjMtOWQ3Ny0wNTRmMDY5MGU0OTgiLCJhdWQiOlsicmVmcmVzaCJdLCJleHAiOjE4MzQwNTI0MzgsIm5iZiI6MTY2MTI1MjQzOCwiaWF0IjoxNjYxMjUyNDM4LCJqdGkiOiI2MTg3YTI1Ni0zZjg3LTQwZDktOGFhZi01MzlmMzEzNDFkNTYifQ.AWQ9-QPvCoqRIq1I8_xGfCyv8KDgDaQBiGrtqmnJeW78_4HKcjTqMG6E30O6R2nV7XuVhz-ZRmLHgng2pdCem2L6BC2maPSI4U9YZ9Lh_Bp-K_niS-cgqFxm6akjHpFAxzE2Y-7ZqE30Wp_U2B3ts9-6EL7tyx1FMQZ_lgIGeto"),
			},
		...
		},
		{
			...
			args: args{
				token: entity.NewToken("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdWQiO1JhY2Nlc3MiLCJqdGkiOiJjMzE3OWQwZC0zM2VkLTQ0ZjYtOGEyMS05MzExZGExMWU3OWYiLCJzdWIiOiJjYzRhMzU1YS05NDdmLTRmYTQtYWY0Ny00ZmZmMWVhZTA2YTEifQ.6-U_fSeDCLfXtYlJ6aivTw-4O3-EuVVw2KYWNNay5zU"),
			},
			wantErr: errs.NewBadToken(),
		},
	}
